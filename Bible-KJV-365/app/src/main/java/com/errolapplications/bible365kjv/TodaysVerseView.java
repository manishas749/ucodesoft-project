...
public class TodaysVerseView extends AppCompatActivity implements View.OnClickListener {
...
//    private InterstitialAd mTodaysVerseViewInterstitialAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.todays_verse_view);
...
//        MobileAds.initialize(this, "ca-app-pub-3466626675396064~9254980946");

        mainAdManager = new AdsManager();
        mainAdManager.initialiseAdmob(this);
        mainAdManager.loadInterstitialAd(this, "ca-app-pub-3466626675396064/2560575737");

        mTodaysVerseViewBannerAd = findViewById(R.id.adView1);
        mainAdManager.loadBannerAd(mTodaysVerseViewBannerAd);
...
//        mScrollView = findViewById(R.id.sub_one_scroll_layout);
        ...
        */
        ...
        mFab.setOnClickListener(view -> {
            ...
            Intent intent;
            intent = new Intent(TodaysVerseView.this, BibleBookActivity.class);
...
//            mScrollView.setBackgroundColor(this.getColor(R.color.darker_grey));
    ...
    public void updateDailyVerseInActivity(DailyVerse verse) {
        ...
        TodaysVerseViewCursorAdapter dvca = new TodaysVerseViewCursorAdapter(this, verse.getVerseCursor());
...
//                    }
                ...
                mGetBook = mSharedPreferences.getString("book", "");
                mGetChapter = mSharedPreferences.getString("chapter", "");
                // mGetChapterInt = Integer.parseInt(mGetChapterInt);
                //mGetChapterInt = mGetChapterInt - 1;
    ...
    public void oldTestBooks() {
        ...
        switch (mGetBook) {
            ...
            case "Genesis":
                ...
                intent = new Intent(TodaysVerseView.this, BibleBookVersesOldTestActivity.class);
    ...
    public void newTestBooks() {
        ...
        switch (mGetBook) {
            ...
            case "Matthew":
                ...
                intent = new Intent(TodaysVerseView.this, BibleBookVersesNewTestActivity.class);
