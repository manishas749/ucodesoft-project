...
public class BibleBookLastReadVersesNewTestActivity extends AppCompatActivity {
...
//        mBibleVersesOldTestBackPressedInterstitial.setAdUnitId("ca-app-pub-3466626675396064/9600385904");
...
//        mBibleVersesOldTestFabInterstitial.setAdUnitId("ca-app-pub-3466626675396064/4427950272");
...
//        });
        ...
        mDailyBookSelected = getIntent().getIntExtra("new_test_last_read_book", 0);
        mDailyChapterSelectedString = getIntent().getStringExtra("new_test_last_read_chapter");
   ...
   /*     mFab = findViewById(R.id.fab);
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(BibleBookLastReadVersesNewTestActivity.this, MainActivity.class);
    ...
    */
        ...
        mHome.setOnClickListener(view -> {
            ...
            Intent intent;
            intent = new Intent(BibleBookLastReadVersesNewTestActivity.this, MainActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);

            if (mCountClicksBack % 3 == 0) {

                backPressAdManager.showInterstitialAd(BibleBookLastReadVersesNewTestActivity.this);
                mSharedPreferences.edit().putInt("CountPrefs", 0).apply();
                mCountClicksBack = mSharedPreferences.getInt("CountPrefs", mCountClicksBack);
...
//                    }
    ...
    private void loadAds() {
        ...
        backPressAdManager.loadInterstitialAd(this, "ca-app-pub-3466626675396064/9600385904");
...
//                            }
                    ...
                    Intent intent = new Intent(BibleBookLastReadVersesNewTestActivity.this, BibleBookActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
...
//                            }
                    ...
                    Intent intent2 = new Intent(BibleBookLastReadVersesNewTestActivity.this, SettingsActivity.class);
...
//                            }
                    ...
                    Intent intent3 = new Intent(BibleBookLastReadVersesNewTestActivity.this, MainActivity.class);
