...
public class DailyVerseCursorAdapter extends CursorAdapter {
    ...
    public DailyVerseCursorAdapter(Context context, Cursor c) {
        super(context, c, 0);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        return LayoutInflater.from(context).inflate(R.layout.daily_verse_item, parent, false);
    }
