...
public class NearbyCinemasAdapter extends RecyclerView.Adapter<NearbyCinemasAdapter.ViewHolder> {
    Context context;
    private List<Cinema> dataList;
    private LayoutInflater inflater;

    // Constructor
    public NearbyCinemasAdapter(Context context, List<Cinema> dataList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_cinema_nearby, parent, false);
